...
set(_exported_dependencies "control_msgs;hardware_interface;lifecycle_msgs;pluginlib;rclcpp_lifecycle;ros2_control_test_assets")
...
if(NOT _exported_dependencies STREQUAL "")
  ...
  foreach(_dep ${_exported_dependencies})
    ...
    if(_libraries)
      ...
      list(APPEND _libraries ${hardware_interface_testing_LIBRARIES})
      list(REMOVE_DUPLICATES _libraries)
      set(hardware_interface_testing_LIBRARIES ${_libraries})
    endif()
  endforeach()
endif()
