...
set(_exported_dependencies "ament_index_cpp;controller_interface;controller_manager_msgs;hardware_interface;lifecycle_msgs;pluginlib;rclcpp;realtime_tools;std_msgs")
...
if(NOT _exported_dependencies STREQUAL "")
  ...
  foreach(_dep ${_exported_dependencies})
    ...
    if(_libraries)
      ...
      list(APPEND _libraries ${controller_manager_LIBRARIES})
      list(REMOVE_DUPLICATES _libraries)
      set(controller_manager_LIBRARIES ${_libraries})
    endif()
  endforeach()
endif()
